...
| ✅ Workshop Day 4 | 2026-04-25, 8:30 | [Caching, Real-time, Resilience & Background Processing](docs/day4/) |
| ✅ Workshop Day 5 | 2026-05-09, 8:30 | [Testing, Versioning, Observability & Capstone](docs/day5/) |
...
| Lab | Day | Topic | Scaffold Level |
|---|---|---|---|
| [Lab 1: Build the Events API](labs/lab1-events-api/) | Day 1 | Minimal APIs, OpenAPI, Scalar | Level 1 (80% starter) |
| [Lab 2: Persist & Validate TechConf](labs/lab2-persistence-validation/) | Day 2 | EF Core 10, FluentValidation, Problem Details | Level 1-2 (60% starter) |
| [Lab 3: Orchestrate, Secure & Structure](labs/lab3-aspire-auth-architecture/) | Day 3 | .NET Aspire, Keycloak, VSA/MediatR | Level 2 (50% starter) |
| [Lab 4: Make TechConf Production-Ready](labs/lab4-cache-realtime-resilience/) | Day 4 | HybridCache, SignalR, Polly, RabbitMQ | Level 2-3 (40% starter) |
| [Capstone: Speaker Submission Portal](labs/capstone/) | Day 5 | Full integration project | Level 4 (requirements only) |
| [Optional Lab: Dependency Injection with Application Builder](labs/lab-di-console/) | Self-study | `Host.CreateApplicationBuilder`, service lifetimes, manual scopes | Level 1 (60% starter) |
| [Optional Lab: Crystal Rush Multiplayer](labs/lab-signalr-multiplayer/) | Self-study | SignalR, React, Avalonia, .NET Aspire | Level 2 (50–60% starter) |

### Elective Labs

| Lab | Topic |
|---|---|
| [GraphQL with Hot Chocolate](labs/lab-graphql/) | GraphQL API, DataLoaders, Pagination |
| [gRPC in .NET](labs/lab-grpc/) | Protocol Buffers, Server Streaming, Reflection |
| [OData API](labs/lab-odata/) | OData Conventions, Functions, Actions |
| [Model Context Protocol](labs/lab-mcp/) | MCP Server, Tools, Prompts |
| [Keycloak with React](labs/lab-keycloak-react/) | Keycloak OIDC, Aspire, React SPA |
...
git clone https://github.com/florianwachs/AspNetWebservicesCourse2026.git
cd AspNetWebservicesCourse2026
...
> [!IMPORTANT]
> Be present at the required workshop days.
