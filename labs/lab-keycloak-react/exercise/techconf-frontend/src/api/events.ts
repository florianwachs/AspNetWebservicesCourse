...
// TODO: Task 6 — Implement createEvent that sends a POST request with the JWT token
// Hint:
...
// TODO: Task 6 — Implement deleteEvent that sends a DELETE request with the JWT token
// Hint:
